const CACHE='women-medicine-notebook-v5';
const FILES=['./','index.html','style.css','app.js','assets/app-icon.webp','assets/woman-notebook.webp','apple-touch-icon.png?v=5','apple-touch-icon.png','assets/icon-192.png','assets/icon-512.png','manifest.webmanifest'];
